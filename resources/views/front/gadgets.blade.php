	...
	<main class="max-w-[640px] mx-auto min-h-screen flex flex-col relative has-[#Bottom-nav]:pb-[144px]">
		...
		<section id="brand"
			...
			<div class="flex flex-col items-end gap-[2x]">
				...
				<p class="text-sm leading-[21px] text-[#6E6E70] text-nowrap">{{ $brand->products->count() }}</p>
			</div>
		</section>
        ...
        @empty
        <p>Tidak ada produk dari brand {{ $brand->name }} di kategori ini</p>
        @endforelse
